...
# analysis year range
(analysis_year_range <- c(as.character(unique(azdhs_suicide_data$year_analysis_ll):unique(azdhs_suicide_data$year_analysis_current))))
...
# pin details
pin_title <- str_c(
  "Death by suicide, race specific rates (",
  min(death_by_suicide_coconino_resident_race_specific_rate$death_book_year),
  "-",
  max(death_by_suicide_coconino_resident_race_specific_rate$death_book_year),
  ")"
)

pin_desc <- str_c(
  "Race specific rates of death by suicide for Coconino County Residents (",
  min(death_by_suicide_coconino_resident_race_specific_rate$death_book_year),
  "-",
  max(death_by_suicide_coconino_resident_race_specific_rate$death_book_year),
  ")."
